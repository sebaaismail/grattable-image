(function (cjs, an) {
  ...
  var ss = {};
  var img = {};
  lib.ssMetadata = [{ name: "testA_atlas_1", frames: [[0, 0, 347, 356]] }];
  ...
  (lib.pastille = function () {
    this.initialize(ss["testA_atlas_1"]);
    this.gotoAndStop(0);
  ...
  (lib.Symbole1 = function (mode, startPosition, loop, reversed) {
    ...
    // Calque_1
    this.instance = new lib.pastille();

    this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

    this._renderFirstFrame();
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = new cjs.Rectangle(0, 0, 347, 356);

  // stage content:
  (lib.testA = function (mode, startPosition, loop, reversed) {
    if (loop == null) {
      loop = true;
    }
    if (reversed == null) {
  ...
  p.nominalBounds = new cjs.Rectangle(-39.3, 178.8, 182.60000000000002, 187.3);
  // library properties:
  lib.properties = {
    id: "C3A76A04A9FDE541BF8B8AF7556BE5FD",
    width: 1,
    height: 1,
    fps: 24,
    color: "#FFFFFF",
    opacity: 1.0,
    manifest: [
      { src: "images/testA_atlas_1.png?1628525062623", id: "testA_atlas_1" },
    ],
    preloads: [],
  };
  ...
  an.compositions["C3A76A04A9FDE541BF8B8AF7556BE5FD"] = {
    getStage: function () {
